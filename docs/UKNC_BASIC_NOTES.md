...
Клавиша **УСТ** (код 0152, на PC-клавиатуре эмулятора — в районе Scroll Lock) открывает
«УСТАНОВКА РЕЖИМОВ» поверх любой программы. Меню работает и в эмуляторе, и поверх Бейсика:
...
Ходить так: цифра выбирает строку, **вправо** входит в подменю, **вверх-вниз** двигают,
**ввод** применяет, **УСТ** закрывает.
