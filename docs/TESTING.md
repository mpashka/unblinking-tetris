...
| выбор уровня перед партией | цифра на заставке задаёт уровень и скорость, любая другая клавиша — нулевой |
| таблица рекордов | мимо таблицы — не спрашивают имени; попал — строка встаёт на своё место, нижние сдвигаются |
| ввод имени | восемь знаков, забой, буква после ESC (стрелка) в имя не попадает |
...
целая партия, выбор уровня, таблица рекордов со строковыми массивами и `MID$`,
и запрет двоеточия.
...
| игра набирается и компилируется | ✅ около 600 строк | — |
...
| выбор уровня цифрой на заставке | ✅ нажали `3` — партия пошла с третьего уровня | — |
| таблица рекордов и ввод имени | ✅ ![ввод имени](img/tetris-name.png) счёт 488 обошёл последнюю строку, имя `PASHA` встало в таблицу | — |
